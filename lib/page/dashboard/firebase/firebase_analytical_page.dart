...
import 'firebase_tab_page.dart';

class FirebaseAnalyticalPage extends StatelessWidget {
  static const routeName = '/firebase_analytical';

  const FirebaseAnalyticalPage({Key? key}) : super(key: key);
